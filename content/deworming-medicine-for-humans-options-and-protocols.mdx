...
Mebendazole mostly treats infections from [pinworms](/medical-uses/ivermectin-for-pinworms-effectiveness-and-protocol), whipworms, and hookworms. It stops the worms from taking up glucose.
...
In some cases, deworming pills are sold [over the counter](/buying-guide/ivermectin-over-the-counter-states-where-available). They are easy to get and can treat common infections at home. Pyrantel pamoate is one such drug. It is often used for pinworms and some other worms.
