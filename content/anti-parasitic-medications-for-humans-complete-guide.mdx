...
It is important to know the difference between medicines that need a doctor’s order and those that can be bought [over the counter](/buying-guide/ivermectin-over-the-counter-states-where-available) (OTC). 
