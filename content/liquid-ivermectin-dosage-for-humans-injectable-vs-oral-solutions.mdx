...
Topical ivermectin is used mainly for skin problems like head lice and rosacea. It works on the skin’s surface and does not treat internal [parasites](/medical-uses/ivermectin-for-parasites-types-treated-and-effectiveness "Ivermectin for Parasites: Types Treated and Effectiveness"). While it is good for its purpose, it does not give the full-body treatment needed for internal parasites.
