...
**Ivermectin** is a medicine that kills many types of [parasites](/medical-uses/ivermectin-for-parasites-types-treated-and-effectiveness "Ivermectin for Parasites: Types Treated and Effectiveness"). It is mainly used to treat roundworms and parasites like lice and mites. Its way of working involves making the parasite’s cell membranes more open to chloride ions. This causes the parasite to become paralyzed and die. However, tapeworms are a different kind of parasite.
