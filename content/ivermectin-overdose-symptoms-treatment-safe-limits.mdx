...
**Ivermectin** has a wide safe range, but taking too much can cause harm. In humans, the usual dose for infections is about 150 to 200 micrograms per kilogram of body weight. [Overdose](/safety-side-effects/ivermectin-overdose-symptoms-treatment-safe-limits) can happen if someone takes animal medicine meant for bigger animals or if they take too much of the medicine made for humans.
