...
<div className="my-8">
  <img src="/images/ivermectin-ingredients-whats-in-the-[tablets](/dosage-administration/ivermectin-tablets-vs-paste-vs-liquid-which-form-to-choose)-hero.webp" alt="**Ivermectin** Ingredients: What's in the Tablets?" className="rounded-lg w-full" />
</div>
...
When we talk about [ivermectin ingredients](/safety-side-effects/ivermectin-ingredients-whats-in-the-tablets), it helps to first know what the active part is. **Ivermectin** is a type of medicine called an anti-worm drug. It is made from a mix of chemicals called avermectins, which come from a bacteria named *Streptomyces avermitilis*.
...
Ivermectin's chemical shape is complex. It has a large lactone ring at its core. This shape helps it stop [parasites](/medical-uses/ivermectin-for-parasites-types-treated-and-effectiveness) from sending signals in their nerves by attaching strongly to chloride channels that are found only in parasites. This makes the parasite die.
