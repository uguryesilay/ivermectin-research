...
<div className="my-8">
  <img src="/images/ivermectin-[dosage](/dosage-administration/ivermectin-dosage-for-humans-complete-guide-by-weight-and-condition)-for-covid-clinical-trial-protocols-hero.webp" alt="**Ivermectin** Dosage for COVID: Clinical Trial Protocols" className="rounded-lg w-full" />
</div>
...
While ivermectin is safe at normal doses, higher doses used in some COVID trials have raised worries. Common **[side effects](/safety-side-effects/ivermectin-side-effects-complete-safety-guide)** reported include:
